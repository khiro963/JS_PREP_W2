  ...
  function runExperiment(sampleSize) {
    ...
    for (let i = 0; i < sampleSize; i++){
      let randomResultValue = Math.floor(Math.random() * 6) + 1;
      valueCounts[randomResultValue -1 ]++;
    }
    ...
    for ( let vCount of  valueCounts){
      const percentage = (vCount / sampleSize * 100 ).toFixed(2);
